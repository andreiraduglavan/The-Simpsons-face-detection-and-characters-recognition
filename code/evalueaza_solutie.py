...
def evaluate_results_task2(solution_path,ground_truth_path,character, verbose = 0):
	...
	#incarca detectiile + scorurile + numele de imagini	
	detections = np.load(solution_path + "detections_" + character + ".npy")
	print(detections.shape)

	scores = np.load(solution_path + "scores_"+ character + ".npy")
	print(scores.shape)
	
	file_names = np.load(solution_path + "file_names_"+ character + ".npy")
	print(detections.shape)
...
solution_path_root = "../data/salveazaFisiere/evaluate/"
ground_truth_path_root = "../data/gt/"
#dir_save_files = 

#task1
solution_path = solution_path_root + "task1/"
ground_truth_path = ground_truth_path_root + "task1_gt.txt"
...
ground_truth_path = ground_truth_path_root + "task2_marge_gt.txt"
evaluate_results_task2(solution_path, ground_truth_path, "marge", verbose)

ground_truth_path = ground_truth_path_root + "task2_bart_gt.txt"
evaluate_results_task2(solution_path, ground_truth_path, "bart", verbose)

ground_truth_path = ground_truth_path_root + "task2_homer_gt.txt"
evaluate_results_task2(solution_path, ground_truth_path, "homer", verbose)

ground_truth_path = ground_truth_path_root + "task2_lisa_gt.txt"
evaluate_results_task2(solution_path, ground_truth_path, "lisa", verbose)
