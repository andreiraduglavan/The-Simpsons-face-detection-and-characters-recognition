...
class Parameters:
    def __init__(self):
        ...
        self.dir_test_examples = os.path.join(self.base_dir, 'TestData//') # 'exempleTest/CursVA'   'exempleTest/CMU+MIT'
        self.path_annotations = os.path.join(self.base_dir, 'TestData.txt') 
        ...
        self.overlap = 0.3
        self.number_positive_examples = 500  # numarul exemplelor pozitive
        self.number_negative_examples = 1000  # numarul exemplelor negative
